...
- WLoRA works better than training a LoRA from scratch in few-shot adaptation. However, when the training data increases, training a LoRA from scratch outperforms WLoRA since it has more trainable parameters.
