...
def main(args):
    ...
    train_dataloader = torch.utils.data.DataLoader(
        ...
        num_workers=args.train_batch_size * 2,
    )
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                if global_step % args.validation_steps == 0 and global_step != 0:
                    ...
                    logger.info(
                        ...
                        f" {validation_prompts[0]}, {validation_prompts[1]} ......"
                    )
                    # create pipeline
                    pipeline = DiffusionPipeline.from_pretrained(
                        args.pretrained_model_name_or_path,
                    ...
                    # run inference
                    generator = torch.Generator(device=accelerator.device).manual_seed(global_seed)
