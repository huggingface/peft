...
class AdaMSSTrainingArguments:
    ...
    model_name_or_path: str = field(
        default="roberta-base", metadata={"help": "Model identifier: roberta-base or roberta-large"}
    )
    dataset_name: str = field(default="cola", metadata={"help": "GLUE task: cola, mrpc, sst2, qnli, rte, stsb"})
...
def main():
    ...
    train_ds, val_ds, _test_ds = get_dataset(args, tokenizer)
