...
if args.residual_model_name_or_path is None:
    ...
    args.residual_model_name_or_path = args.output_path
    pissa_pre_training_saving(peft_model, tokenizer, save_path=args.residual_model_name_or_path, push_to_hub=None)
