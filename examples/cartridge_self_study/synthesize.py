...
def synthesize_self_study_jsonl(
    *,
    ...
    corpus_token_ids = tokenizer(corpus_text, return_tensors=None, add_special_tokens=False)["input_ids"]
    ...
    for _ in range(num_samples):
        ...
        teacher_out = model.generate(teacher_prompt, **gen_kwargs)
        student_out = model.generate(student_prompt, **gen_kwargs)
