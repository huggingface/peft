...
def main():
    ...
    print(f"LR schedule: warmup={args.warmup_steps} steps, cosine decay over {args.num_steps} steps")
    print(f"  model lr={args.lr}, sampler lr={args.sampler_lr} (x{args.warmup_steps})")
