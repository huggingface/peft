...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--sd_checkpoint', default=None, type=str, required=True, help='SD checkpoint to use'
    )
    ...
    text_encoder_modules_names = get_modules_names(
        text_encoder,
        target_replace_modules_linear=TEXT_ENCODER_TARGET_REPLACE_MODULE
    )
    ...
    with safetensors.safe_open(args.kohya_lora_path, framework="pt", device="cpu") as f:
        ...
        unet_config = LoraConfig(
            ...
            target_modules=unet_modules_names,
            lora_dropout=0.0,
            bias='none'
        )
