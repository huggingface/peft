...
from .layer import FourierLinear, FourierLayer
...
class FourierModel(BaseTuner):
    ...
    **Attributes**:
    ...
    def merge_and_unload(
        ...
        r"""
        This method merges the Fourier layers into the base model. This is needed if someone wants to use the base model
