...
class Embedding(nn.Embedding, VeraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        raise NotImplementedError("Embedding not yet implemented for new memory efficient implementation.")
        init_vera_weights = kwargs.pop("init_vera_weights", True)
...
class Conv2d(nn.Conv2d, VeraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        raise NotImplementedError("Conv2d not yet implemented for new memory efficient implementation.")
        init_vera_weights = kwargs.pop("init_vera_weights", True)
    ...
    def get_delta_weight(self, adapter) -> torch.Tensor:
        ...
        if self.weight.size()[2:4] == (1, 1):
            # conv2d 1x1
            output_tensor = (
                (lambda_b @ weight_B.squeeze(3).squeeze(2) @ lambda_d @ weight_A.squeeze(3).squeeze(2))
                .unsqueeze(2)
                .unsqueeze(3)
            )
        else:
