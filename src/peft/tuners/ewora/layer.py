...
class EworaLayer(BaseTunerLayer):
    ...
    def update_layer(self, adapter_name, r, ewora_alpha, ewora_dropout, use_rslora, use_dora, num_experts):
        if r <= 0:
            raise ValueError("`r` should not be 0 or non-negative")
        ...
        self.reset_ewora_parameters(adapter_name)
    ...
    def reset_ewora_parameters(self, adapter_name):
...
class Linear(nn.Linear, EworaLayer):
    def __init__(
        ...
        **kwargs,
        ...
        self.update_layer(adapter_name, r, ewora_alpha, ewora_dropout, use_rslora, use_dora, num_experts)
