...
class Linear(nn.Module, aLoraLayer):
    ...
    #     warnings.warn("NOT SUPPORTED FOR ASYMMETRIC LORA")# added
...
#below not supported
# class Embedding(nn.Module, aLoraLayer):
...
#         super().__init__()
#         aLoraLayer.__init__(self, base_layer)
...
# class _ConvNd(nn.Module, aLoraLayer):
