...
from .layer import MoSLinear


class TorchaoLoraLinear(MoSLinear):
    ...
    def __init__(self, *args, get_apply_tensor_subclass, **kwargs):
        ...
        if kwargs.get("moslora_bias", False):
            raise ValueError(f"{self.__class__.__name__} does not support moslora_bias yet, set it to False")
    ...
    def __repr__(self) -> str:
        rep = super().__repr__()
        return rep.replace("moslora.MoSLinear", f"moslora.{self.__class__.__name__}")
