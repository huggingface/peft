...
if is_bnb_available():
    ...
    class Linear8bitLt(torch.nn.Module, MoSLoraLayer):
        ...
        def __init__(
            ...
            use_moslora: Union[bool, str] = True, 
            **kwargs,
        ) -> None:
            super().__init__()
        ...
        def merge(self, safe_merge: bool = False, adapter_names: Optional[list[str]] = None) -> None:
            ...
            for active_adapter in adapter_names:
                ...
                warnings.warn(
                    "Merge moslora module to 8-bit linear may get different generations due to rounding errors."
                )
        ...
        def get_delta_weight(self, adapter):
            if isinstance(self.use_moslora[adapter], str) or self.use_moslora[adapter] is True:
                return (
                    transpose(
        ...
        def _mixed_batch_forward(
            ...
            for i, active_adapter in enumerate(unique_adapters):
                ...
                if isinstance(self.use_moslora[active_adapter], str) or self.use_moslora[active_adapter] is True:
...
if is_bnb_4bit_available():
    ...
    class Linear4bit(torch.nn.Module, MoSLoraLayer):
        # Lora implemented in a dense layer
        def __init__(
            self,
            base_layer: torch.nn.Module,
        ...
        def merge(self, safe_merge: bool = False, adapter_names: Optional[list[str]] = None) -> None:
            ...
            for active_adapter in adapter_names:
                ...
                warnings.warn(
                    "Merge moslora module to 4-bit linear may get different generations due to rounding errors."
                )
