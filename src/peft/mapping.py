...
def inject_adapter_in_model(
    peft_config: PeftConfig, model: torch.nn.Module, adapter_name: str = "default", init_empty: bool = False
) -> torch.nn.Module:
    r"""
    ...
    peft_model = tuner_cls(model, peft_config, adapter_name=adapter_name, init_empty=init_empty)
