...
class BenchmarkResult:
    ...
    def __post_init__(self):
        ...
        self.run_info = {
            ...
            "hardware": {
                "num_accelerators": (
                    torch_accelerator_module.device_count() if torch_accelerator_module.is_available() else 0
                ),
                "accelerator_type": (
                    torch_accelerator_module.get_device_name(0) if torch_accelerator_module.is_available() else "N/A"
                ),
