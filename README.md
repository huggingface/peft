...
12. BOFT: [Parameter-Efficient Orthogonal Finetuning via Butterfly Factorization](https://arxiv.org/abs/2311.06243)
...
| Model            | LoRA | LoHa | LoKr | OFT | BOFT | Prefix Tuning | P-Tuning | Prompt Tuning | IA3 |
| ---------------- | ---- | ---- | ---- | --- | ---- | ------------- | -------- | ------------- | --- |
| Stable Diffusion | ✅   | ✅   | ✅   | ✅  | ✅   |               |          |               |     |
| DreamBooth       | ✅   |      |      | ✅  | ✅   |               |          |               |     |
| ControlNet       |      |      |      | ✅  | ✅   |               |          |               |     |
...
examples to learn more. If you run into problems, please open an issue._**
