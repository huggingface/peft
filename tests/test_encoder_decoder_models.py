...
def skip_non_lora(test_list):
    return [t for t in test_list if "lora" in t[0]]
...
class PeftEncoderDecoderModelTester(unittest.TestCase, PeftCommonTester):
    ...
    @parameterized.expand(PeftTestConfigManager.get_grid_parameters(FULL_GRID, filter_params_func=skip_non_lora))
