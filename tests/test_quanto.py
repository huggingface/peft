...
def make_automodel_proxy(weights: str):
    ...
    """
    # TODO: switch to QuantoConfig once https://github.com/huggingface/transformers/pull/31732 is merged

    from optimum.quanto import qfloat8, qint2, qint4, qint8, quantize
