...
class PeftHqqGPUTests(unittest.TestCase):
    ...
    @pytest.mark.xfail(reason="HQQ is not yet supported by Transformers v5", strict=True, raises=NotImplementedError)
    @pytest.mark.single_gpu_tests
...
class PeftEetqGPUTests(unittest.TestCase):
    ...
    @pytest.mark.xfail(reason="EETQ is not yet supported by Transformers v5", strict=True, raises=NotImplementedError)
    @pytest.mark.single_gpu_tests
