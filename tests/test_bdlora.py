...
def test_block_diagonal_linear_forward_matches_dense_equivalent(nblocks, in_features, out_features, input_shape):
    torch.manual_seed(0)
...
def test_bdlora_merge_delta_matches_manual_dense_equivalent(bdlora_config):
    torch.manual_seed(0)
